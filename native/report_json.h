...
namespace scitt_sd::cli
{
  ...
  // bytes, and are deliberately looser than the web layer's own limits: the
  // tool refuses what it cannot faithfully represent, and leaves editorial
  ...
  //
  // Throws UsageError describing the first problem found.
